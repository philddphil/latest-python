...
p0 = (r"C:\local files\Experimental Data\F5 L10 Confocal measurements") +\
    (r"\SCM Data 20200113\PSats\Peak 1 Isat - 13Jan20-001.txt")
p1 = (r"C:\local files\Experimental Data\F5 L10 Confocal measurements") +\
    (r"\SCM Data 20200113\PSats")

data = np.genfromtxt(p0, delimiter=',', skip_header=0)
with open(p0) as f:
    content = f.readlines()
...
prd_plots.PPT_save_2d(fig2, ax2, 'peak1.png')
