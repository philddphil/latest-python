...
p0 = (r"D:\Experimental Data\Spectrometer (Ganni F5 L10)\Spec data 20190315")
os.chdir(p0)
...
ax1.set_xlabel('Wavelength (λ) / nm')
ax1.set_ylabel('Counts')
ax1.plot(λs[a], ctss[a], '.', alpha=0.5, color=cs['gglred'], label='front a')
ax1.plot(λs[a], ctss[a], alpha=0.8, color=cs['ggdred'], lw=0.5, label='')
ax1.plot(λs[b], ctss[b]+500, '.', alpha=0.5, color=cs['gglblue'], label='front b')
ax1.plot(λs[b], ctss[b]+500, alpha=0.8, color=cs['ggdblue'], lw=0.5, label='')
