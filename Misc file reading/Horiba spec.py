...
ax1.set_xlabel('Wavelength (λ) / nm')
ax1.set_ylabel('Counts')
ax1.plot(λs[0], ctss[0], '.', alpha=0.1, color=cs['gglred'], label='mmf')
ax1.plot(λs[0], ctss[0], alpha=0.5, color=cs['ggdred'], lw=0.5, label='')
ax1.plot(λs[1], ctss[1], '.', alpha=0.1, color=cs['gglblue'], label='smf')
ax1.plot(λs[1], ctss[1], alpha=0.5, color=cs['ggdblue'], lw=0.5, label='')
