...
def plot_g2_fits_win(d1, g2s, bin_edges, xlim, mks=13):
    a = 0.5
    b = 0.002
    c = 1.5
    d = 0.00001
...
def plot_g2_fits_ss(d1, g2s, bin_edges, xlim, mks=13):
    a = 0.5
    b = 0.002
    c = 1.5
    d = 0.00001
...
# Data directories
d0_NV = (
    r"C:\local files\Compiled Data\Nu Quantum\Sample 2\Example NV\HH T3 150007")

d0_hBN = (
    r"C:\local files\Compiled Data\Nu Quantum\Sample 2\A2 C4 data\Peak 21\HH")


# Prep more directories to organise data
d1s_NV = prep_dirs_chs(d0_NV, ' win')
d1w_NV = prep_dirs_chs(d0_NV, ' ss_')
...
# try loading histogram with t_res and t_range. If doesn't excist,
# and save will hist data
...
# Load data generated previously
...
# Plot datasets
# plot_1d_hist(d1s_hBN, hist_s, bin_edges_s, 1e5)
# plot_1d_hist(d1w_hBN, hist_w, bin_edges_w, 1e5)
